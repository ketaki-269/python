# single line conditional statement or ternary operator
...
# # ans = "Divisible "if num%5==0 else "Not divisible"
# # print (ans)
...
# # num=int(input("Enter number :"))
# # ans = "Divisible "if num%7==0 else "Not divisible"
# # print (ans)
...
# # password=int(input("Enter Password:"))
# # ans = "Successful " if password==1234 and username =="user@gmail.com"  else "NOt "
# # print (ans)
